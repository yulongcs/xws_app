...
window.onload = function () {
    ...
    var oContactContent3 = getByClass(oContactContent, 'contactContent3')[0];
    ...
    function showLoading() {
        ...
        var arr = ['slides/slide0.jpg', 'slides/slide1.jpg', 'slides/slide2.jpg', 'slides/slide3.jpg', 'slides/slide4.jpg', 'slides/slide5.jpg','bg1.jpg', 'bg2.jpg', 'bg3.jpg', 'bg4.jpg', 'bg5.jpg', 'about1.jpg', 'about2.jpg', 'about3.jpg', 'about4.jpg', 'worksimg1.jpg', 'worksimg2.jpg', 'worksimg3.jpg', 'worksimg4.jpg', 'team.png', 'greenLine.png'];
        var iNow = 0;
    ...
    function listContentAuto() {
        var mt = (iContentHeight - 620) / 2;
        oHomeContent.style.marginTop = mt + 'px';
    ...
    function workContent() {
        //oWorksContent2
        //var data = [
		//	{ img: 'images/worksimg1.jpg', text: '测试文字，哈哈哈啊司法所地1' },
		//	{ img: 'images/worksimg2.jpg', text: '测试文字，哈哈哈啊司法所地2' },
		//	{ img: 'images/worksimg3.jpg', text: '测试文字，哈哈哈啊司法所地3' },
		//	{ img: 'images/worksimg4.jpg', text: '测试文字，哈哈哈啊司法所地4' }
        //];
    ...
    function homeContent() {
        ...
        var data = [
         { img: 'images/slides/slide0.jpg', text: '' },
         { img: 'images/slides/slide1.jpg', text: '' },
         { img: 'images/slides/slide2.jpg', text: '' },
         { img: 'images/slides/slide3.jpg', text: '' },
         { img: 'images/slides/slide4.jpg', text: '' },
         { img: 'images/slides/slide5.jpg', text: '' }
       ];
        ...
        function create() {
            for (var i = 0; i < data.length; i++) {
                ...
                oLi1.innerHTML = '<img class="commonImage" src=' + (data[i].img) + ' />';
    ...
    function courseContent() {
       //oCourseContent3
       var data = [
			{ img: 'images/course/ws1.jpg', text: '舞社大教室' },
			{ img: 'images/course/ws2.jpg', text: '舞社休息区' },
            { img: 'images/course/ws3.jpg', text: '灯光下的教室' },
            { img: 'images/course/ws4.jpg', text: '舞社大教室' },
            { img: 'images/course/ws5.jpg', text: '少儿舞蹈教室' },
            { img: 'images/course/ws1.jpg', text: '测试文字111' },
            { img: 'images/course/ws1.jpg', text: '测试文字111' },
            { img: 'images/course/ws1.jpg', text: '测试文字111' },
            { img: 'images/course/ws1.jpg', text: '测试文字111' },
            { img: 'images/course/ws1.jpg', text: '测试文字111' },
    ...
    function getByClass(oParent, sClass) {
        ...
        for (var i = 0; i < aElem.length; i++) {
            var clslist = aElem[i].className.split(' ');
            if (clslist.indexOf(sClass) !== -1) {
                arr.push(aElem[i]);
            }
        }
        return arr;
